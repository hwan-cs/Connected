...
class ChatTableViewCell: UITableViewCell, ShimmeringViewProtocol
{
    ...
    weak var parentVC : ChatViewController?
    ...
    @objc func didTapTimeLabel(tapGestureRecognizer: UITapGestureRecognizer)
    {
        ...
        infoPopTip.show(text: self.date!, direction: .left, maxWidth: 200, in: self.contentView, from: lbl.frame)
    }
    ...
    @objc func didTapDateLabel(tapGestureRecognizer: UITapGestureRecognizer)
    {
        ...
        infoPopTip.show(text: self.time!, direction: .left, maxWidth: 200, in: self.contentView, from: lbl.frame)
    }
